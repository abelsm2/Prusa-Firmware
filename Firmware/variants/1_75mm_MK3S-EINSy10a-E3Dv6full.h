...
// Printer name
#define CUSTOM_MENDEL_NAME "Micah's i3 MK3S" // abelsm2 modified to custom name
...
#define MANUAL_Y_HOME_POS 0 //abelsm2 (was -2.2) adjusting this to account for custom Y-Axis components
