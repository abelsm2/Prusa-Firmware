...
/*	if (mcu & 1) SERIAL_ECHOLNRPGM(MSG_POWERUP);
	...
	tmc2130_mres[X_AXIS] = tmc2130_usteps2mres(TMC2130_USTEPS_X); // abelsm2
	tmc2130_mres[Y_AXIS] = tmc2130_usteps2mres(TMC2130_USTEPS_Y); // abelsm2
...
//        destination[axis] = 11.f;
		...
		if (tmc2130_home_enabled && (orig <= kHOMING_CNT_MIN)) // abelsm2 adjustable for 0.9 motors
		{
...
void gcode_M701()
{
	...
	else
	{
        ...
        // abelsm2 first part of load filament using rate and distance from variant settings
