...
#ifdef TMC2130
    { TMC2130_USTEPS_X, TMC2130_USTEPS_Y, TMC2130_USTEPS_Z, TMC2130_USTEPS_E }, // abelsm2
#else // TMC2130
    {16,16,16,16},
#endif
  ...
  bool previous_settings_retrieved = true;
    ...
    for (uint8_t j = X_AXIS; j <= Y_AXIS; j++)
    {
      ...
      if (cs.max_acceleration_units_per_sq_second_silent[j] > SILENT_MAX_ACCEL_XY)
		...
		if(cs.axis_ustep_resolution[X_AXIS] == 0xff){ cs.axis_ustep_resolution[X_AXIS] = TMC2130_USTEPS_X; } // abelsm2
		if(cs.axis_ustep_resolution[Y_AXIS] == 0xff){ cs.axis_ustep_resolution[Y_AXIS] = TMC2130_USTEPS_Y; } // abelsm2
